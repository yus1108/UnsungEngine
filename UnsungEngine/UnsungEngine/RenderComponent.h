...
protected:
	...
	UEngine::RenderToTexture * m_pRTT;
...
public:
	...
	virtual void Init(ID3D11DeviceContext * deviceContext, UEngine::pipeline_state_t * pipeline, UEngine::RenderToTexture * rtt, D3D11_VIEWPORT * viewport) = 0;
